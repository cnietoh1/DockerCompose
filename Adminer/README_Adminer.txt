Instrucciones de despliegue Adminer
...
Acceder a la url del servicio web, en este caso localhost:8084 ya que es el puerto asignado en el fichero yml.
Una vez dentro acceder con las credenciales establecidas en el fichero yml a la BBDD.